...
|---|---|---|
| `border_optics_control_villages_PRE_ENTRY24_FIX.csv` | `data/processed/` | The 735-village control list before the coordinate-proximity + official-name-list dedup fix (Development Log Entry 24). Superseded by the current 732-village `border_optics_control_villages.csv`. Kept because it's the source used to independently reproduce the "20 duplicates / 21 treated villages" count in `BO_Research_Paper.md` §4.6 and §6.10 — see `BO_Development_Log.md` Entries 22-25 for the full account. |
