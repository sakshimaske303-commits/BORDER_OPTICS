"""
SUPERSEDED 2026-09-17: consolidated into src/analysis/analyze_results.py, which
now takes --window {summer,full_year} instead of being two copy-pasted files.
Verified byte-for-byte identical output (both the printed stats and the saved
CSV) before this file was archived. Kept here for history only -- see
archive/README.md. Do not run this file; run the consolidated one instead:
