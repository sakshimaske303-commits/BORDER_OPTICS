...
control group of 732 villages and a three-point 2021/2023/2025 trend.
""")
...
with col2:
    ...
    <div class="recon-card" style="border-left: 4px solid {PALETTE['accent_vintage']}; min-height: 210px; margin-bottom: 16px;">
        ...
        <p style="color: {PALETTE['text_primary']}; font-size: 0.9rem; margin: 0;">
            ...
            allocation? Treated as <b>exploratory only</b>, given just three states in the
            core sample — a directional signal, not a confirmatory test.
        </p>
    </div>
    """, unsafe_allow_html=True)
...
<div class="recon-card" style="border-left: 4px solid {PALETTE['accent']}; margin-top: 16px;">
    ...
    <p style="color: {PALETTE['text_primary']}; font-size: 0.9rem; margin: 0;">
        ...
        larger increase than a matched set of 732 non-VVP villages in the same 14
...
with col_b:
    ...
    <div class="recon-card">
        ...
        <p style="color: {PALETTE['text_primary']}; font-size: 0.9rem; margin: 0;">
            ...
            Methodology & Limitations. A district-restricted <b>non-VVP control group</b> of 732 villages,
...
with col_m3:
    st.markdown("3. **Satellite Extraction** — Sentinel-2 NDBI and VIIRS night-lights via Google Earth Engine, run identically for the treated sample and the 732-village non-VVP control group, at three time points (2021/2023/2025) and three buffer radii (250m/500m/1km), cloud-masked composites.")
with col_m4:
...
st.markdown("7. **Control-Group DiD** — 732 non-VVP villages from the same 14 districts, via the OpenStreetMap Overpass API, compared against the treated sample with a district-fixed-effects Difference-in-Differences model (RQ5/H4).")
