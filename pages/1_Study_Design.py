...
<div class="recon-card" style="border-left: 4px solid {PALETTE['accent']}; margin-top: 16px;">
    ...
    <p style="color: {PALETTE['text_primary']}; font-size: 0.9rem; margin: 0;">
        ...
        larger increase than a matched set of 735 non-VVP villages in the same 14
...
with col_m3:
    st.markdown("3. **Satellite Extraction** — Sentinel-2 NDBI and VIIRS night-lights via Google Earth Engine, run identically for the treated sample and the 735-village non-VVP control group, at three time points (2021/2023/2025) and three buffer radii (250m/500m/1km), cloud-masked composites.")
with col_m4:
...
st.markdown("7. **Control-Group DiD** — 735 non-VVP villages from the same 14 districts, via the OpenStreetMap Overpass API, compared against the treated sample with a district-fixed-effects Difference-in-Differences model (RQ5/H4).")
